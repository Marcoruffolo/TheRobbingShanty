...
public class InteractionDetector : MonoBehaviour
{
    ...
    private void DetectInteractable()
    {
        ...
        {
            Debug.Log($"[Interaction] Golpeó: {hit.collider.gameObject.name}");

            IInteractable interactable = hit.collider.GetComponent<IInteractable>();

            if (interactable != null)
            {
                Debug.Log("[Interaction] Interactable encontrado");
            ...
            {
                Debug.Log("[Interaction] No tiene IInteractable");
            }
        }
    ...
    {
        Debug.Log("[Interaction] TryInteract llamado");
